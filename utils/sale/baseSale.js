...
function   GetSale(pm_store,pm_posid,pm_ryid,pm_page,mPageName)
{
 ...
 //初始化字母的列表
  ...
  this.setAllSpList=function(pm_list,pm_price)
  {
	  ...
	  console.log( "绑定完成！"+JSON.stringify( this.Page[this.pageName].spPrice).substr(0,300));
 ...
 console.log("批量设置  哪些功能显示 哪些暂时关闭");
  ///批量设置  哪些功能显示 哪些暂时关闭
