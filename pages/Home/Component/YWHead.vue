	...
	<view>
		...
		<view class="nav n_nav"
			...
			<view class="stores" style="position: absolute;right: 1%;">
				<view class="checkout">
					<label>
						<image src="../../../images/imgpro/biaohh.png" mode="widthFix"></image>
				...
				<view class="account">
					<!-- @click="exits()" -->
					<view class="exit-btn" @click="LoginOut1()">
						<image src="../../../images/imgpro/tuicc.png" mode="widthFix"></image>
						<text>退出</text>
					</view>
